...
class BST {
	...
	// create tree none - public BST()	{} - above
	...
	public void deviationLeft() {
		Vector<Node> Tmp = ListNode; // Create an vector temp to do not change orig values

		// Bubble sort DESC
		for (int i = 0; i < Tmp.size(); i++) {
			for (int j = 0; j < Tmp.size() - i - 1; j++) {
				if (Tmp.get(j).ID > Tmp.get(j+1).ID)
	...
	public static void main(String [] args)	throws Exception{
		...
		*/
		...
		// bst.getElementByName("DucD");
		// System.out.println(bst.Result.get(0).ID);
		
		// bst.getElementByName("Linh");
		// System.out.println(bst.Result.get(0).Birthday);
		
		// bst.getElementByBirthday("4-7-2001");
		// System.out.println(bst.Result.get(0).Name);
		
		// bst.getElementByDTBTL((float)6.5);
		// System.out.println(bst.Result.get(0).Name);
		// System.out.println(bst.Result.get(1).Name);
		
		// bst.getElementBySTCTL(100);
		// System.out.println(bst.Result.get(0).Name);
		// System.out.println(bst.Result.get(1).Name);
		// System.out.println(bst.Result.get(2).Name);
		...
		// bst.getElementBySTCTL(100);
		// removeList.add(bst.Result.get(0));
		// removeList.add(bst.Result.get(1));
		// removeList.add(bst.Result.get(2));
		...
		// bst.Display(bst.getElementByID(10));
		// bst.NLR();
	}
}